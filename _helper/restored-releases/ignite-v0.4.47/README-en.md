<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.4.47-blue?style=for-the-badge&labelColor=1a1a2e" alt="Version" />
...
┌───────────────────────────────────────────────────────┐
│                <span style="color:#88C0D0;">Ignite HttpServer v0.4.47</span>              │
...
> Archive note: this directory is a restored source snapshot for `Ignite v0.4.47`, prepared from the corrected release commit for archival and release use.
