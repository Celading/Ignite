<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.2.2-blue?style=for-the-badge&labelColor=1a1a2e" alt="Version" />
...
> Archive note: this directory is a restored source snapshot for `Ignite v0.2.2`, recovered from legacy history and lightly edited for release readability.



## 为什么选择 Ignite?

> Ignite v0.2.2 captures an early expansion stage where the framework moved from basic routing into a more complete middleware-oriented structure.
