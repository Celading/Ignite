...
| HTTPS / TLS | 稳定继承 + Preview | 默认继续使用稳定的 stdx TLS 路径；显式 Native H1 TLS1.3 会完成 ClientHello、server-flight 验证、client Finished 与 application-data seal/open。 | Native H2 TLS/ALPN、系统 CA、TLS1.2、session resumption、0-RTT、mTLS 与默认切换仍未完成。 |
